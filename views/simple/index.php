...
<div class="header">
    ...
    <div class="date-display" id="headerDate" style="display:none;"><?= date('d.m.Y', strtotime($date)) ?></div> 
</div>
...
(function() {
    ...
    function renderOpening(data) {
        ...
        html += '<thead><tr><th><h2>Початкове сальдо</h2></th><th class="text-right num"><!--Залишок--></th></tr></thead>';
        html += '<tbody>';
    ...
    function renderMovements(data) {
        ...
        if (!data || data.length === 0) {
            container.innerHTML = '<div class="empty-message">Немає переміщень за цю дату</div>';
            return;
        }
    ...
    function renderClosing(data) {
        ...
        let html = '<table class="data-table">';
        html += '<thead><tr><th><h2>Кінцеве сальдо</h2></th><th class="text-right num"><!-- Залишок --></th></tr></thead>';
        html += '<tbody>';
