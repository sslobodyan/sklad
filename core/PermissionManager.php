...
class PermissionManager
{
    ...
    // GET методи = дозволені для рівня 'view'
    const VIEW_METHODS = ['index', 'getone', 'history', 'export', 'get', 'view', 'show'];

    // POST методи = дозволені тільки для рівня 'edit'
    const EDIT_METHODS = [
    ...
    /**
     * Перевірка доступу до матеріалу
     */
    ...
    /**
     * Перевірка доступу до типу ресурсу
     */
    ...
    /**
     * Перевірка чи може редагувати норми списання
     */
    ...
    /**
     * Перевірка чи може експортувати
     */
    ...
    /**
     * Синхронізація поточного користувача (викликати при вході)
     */
